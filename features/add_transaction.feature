...
#    Given the API is running
#    And I add a transaction with timestamp "2025-03-25T11:00:00", token "BTC", amount 100, and price 50000
#    When I try to add the same transaction again
#    Then I should get an error saying "Transaction with timestamp '2025-03-25T11:00:00' and token 'BTC' already exists"
#
