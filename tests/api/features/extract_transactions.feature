Feature: Extract transactions from Debank screenshots
  ...
  Scenario Outline: Parsing valid transactions from mocked OCR
    ...
    And "MAI(miMATIC)" is marked as a stablecoin
    ...
    Examples:
      ...
      | Contract Interaction\nlinch\n-900 MAI(miMATIC)\n($899.91)\n+3.9982 wTAO\n($1,112.67)\n2025/02/06 05.47.49 | 2025-02-06T05:47:49   | wTAO  | 3.9982     | MAI(miMATIC)        | -900.0    |
      | Contract Interaction\nquickswap\n800 MAI(miMATIC)\n(s799.91)\n+3.1982 wTAO\n($1,142.67)\n2025/02/07 06.57.59 | 2025-02-07T06:57:59 | wTAO | 3.1982     | MAI(miMATIC)        | -800.0    |
      | Contract Interaction\nquickswap\n2.005 wTAO\n(s499.91)\n+500.01 MAI(miMATIC)\n($1,312.67)\n2025/02/08 07.07.09 | 2025-02-08T07:07:09 | wTAO | -2.005   | MAI(miMATIC)        | 500.01    |
      | Contract Interaction 1inch 1,800 MAI(miMATIC) ($1,799.55) +4,308.6727 wTAO (61,518.13) 2024/04/13 16.34.49 | 2024-04-13T16:34:49 | wTAO | 4308.6727   | MAI(miMATIC)        | -1800.0   |
      | Contract Interaction 0x5b93..f995 1,008.587 MAI(miMATIC) ($1,008.49) T +2.9089 wTAO ($932.28) 2025/02/07.15.15.11 | 2025-02-07T15:15:11 | wTAO | 2.9089 | MAI(miMATIC)        | -1008.587 |
      | fillOrderArgs Oxa904...ed36 -0.003 wTAO ($303.33) +298.9947 MAI(miMATIC) ($298.96) 2024/12/08 23.02.00 | 2024-12-08T23:02:00 | wTAO | -0.003 | MAI(miMATIC)        | 298.9947 |
      | Contract Interaction linch 1,000.011 wTAO ($297.10) +178.6021MAI(miMATIC) ($298.05) 2025/02/06 05.26.54 | 2025-02-06T05:26:54 | wTAO | -1000.011 | MAI(miMATIC)        | 178.6021 |
      | Contract Interaction 1inch -S0wTAO ($107.69) +112.3998 MAI(miMATIC) ($112.39) 2024/12/07 01.28.08 | 2024-12-07T01:28:08 | wTAO | -50.0| MAI(miMATIC)        | 112.3998 |
